...
function initGUI() {
    gui = new dat.GUI();
    gui.addColor(params, "ambientColor");
    gui.addColor(params, "diffuseColor");
...
function initObject() {
    ...
    let uniforms = {
        ambientColor: { value: new THREE.Color(params.ambientColor) },
        diffuseColor: { value: new THREE.Color(params.diffuseColor) },
        specularColor: { value: new THREE.Color(params.specularColor) },
...
function render() {
    ...
    customMaterial.uniforms.ambientColor.value = new THREE.Color(params.ambientColor);
    customMaterial.uniforms.diffuseColor.value = new THREE.Color(params.diffuseColor);
    customMaterial.uniforms.specularColor.value = new THREE.Color(params.specularColor);
